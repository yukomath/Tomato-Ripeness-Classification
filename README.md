...
### Data Augmentation
Horizontal flip and rotation augmentations were tested during training, but rotation reduced mean Average Precision (mAP) and horizontal flipping provided little benefit. Therefore, **no data augmentation** was applied in the final model.
