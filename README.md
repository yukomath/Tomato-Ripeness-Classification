...
This project implements a tomato ripeness classification system using Mask R-CNN. The model detects and segments tomatoes in images, and classifies them into six ripeness categories. Utilizing the [Laboro Tomato Dataset](https://github.com/laboroai/LaboroTomato), the project covers data preparation, model training, evaluation, and a web application for inference.
...
**Notebook:** 
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1T378e23B6nI3bIUCm63hTady4dFLfbjg)
...
*Note: The model with the highest validation bounding-box mAP is selected as the best model.　The loss is computed on the training set, while mAP metrics are evaluated on the validation set.*
...
Initial experiments were conducted for 20 epochs, but validation performance showed little improvement after epoch 4. As a result,
10 epochs were selected.
